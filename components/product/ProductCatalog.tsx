    ...
    <section id="colecao" className="py-[85px] max-[520px]:py-10">
      <div className="mx-auto max-w-[1200px] px-8 max-[520px]:px-3.5">
        <div className="mb-9 flex flex-wrap items-end justify-between gap-4 max-[520px]:mb-5">
          <div><span className="font-sans text-[.72rem] font-semibold uppercase tracking-[.32em] text-bubble-brown max-[520px]:text-[.6rem] max-[520px]:tracking-[.2em]">Colecao 01 · Linha feminina</span><h2 className="text-[2.6rem] max-[520px]:mt-1 max-[520px]:text-[2rem]">Performance Line</h2></div>
          <p className="max-w-[380px] text-[.9rem] italic leading-[1.6] text-bubble-ink/60 max-[520px]:hidden">Clique na peca para ver detalhes, tecido e sugestao de conjunto. Pecas da colecao nao voltam ao estoque.</p>
        </div>
